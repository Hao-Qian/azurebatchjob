...
namespace AzureBatchJob
{
    class Program
    {
        private const string BatchAccountName = "batchjob";
        private const string BatchAccountKey = "";
        private const string BatchAccountUrl = "https://batchjob.uksouth.batch.azure.com";

        private const string StorageAccountName = "";
        private const string StorageAccountKey = "";

        private static string PoolId = "blobmovepoolid"+ Guid.NewGuid().ToString();
        private static string JobId = "blobmove" + Guid.NewGuid().ToString();
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                const string inputContainerName = "source2";
